...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-app-state.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-app-state',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-app-state.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-app-state.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-app-state.esm.js',
    }),
  ],
};
